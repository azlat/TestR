...
@swisskyrepo
swisskyrepo Polyglot XSS from @filedescriptor's Polyglot Challenge
Latest commit 86db6b7 7 days ago
	.. 		
	Files 	CVE Apache Struts + XSS in Python Notebook 	2 months ago
	Intruders 	SQL injection - Intruders payloads 	2 months ago
	README.md 	Polyglot XSS from @filedescriptor's Polyglot Challenge 	7 days ago
	XSS in Angular.md 	JWT JSON Web Token + SSI files 	9 days ago
	XSS with Relative Path Overwrite.md 	Markdown formatting update 	3 months ago
README.md
